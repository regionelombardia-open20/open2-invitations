...
return [
    ...
    '#import_invitations_not_valid_fiscal_codes' => 'Check these non valid fiscal codes',
    '#import_invitations_users_already_present' => 'The following emails correspond to users already on the platform',
    '#import_invitations_users_already_present_cfs' => 'The following fiscal codes correspond to users already on the platform',
